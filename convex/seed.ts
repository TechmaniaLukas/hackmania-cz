...
const HACKATHONS = [
  ...
  // ── ČESKÁ AI OLYMPIÁDA 2026 — KRAJSKÁ KOLA (NVIAS) ───────────────────────
  {
    slug: "ai-olympiada-2026-ustecky",
    name: "Česká AI Olympiáda 2026 — Ústecký kraj",
    description:
      "Krajské kolo SŠ pro Ústecký kraj. AI Tech kvalifikace probíhala i online pro postup do národního kola.",
    city: "Ústí nad Labem",
    venue: "Krajský úřad Ústeckého kraje",
    startDate: d("2026-04-23T09:00:00"),
    endDate: d("2026-04-23T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/ustecky",
    topics: ["AI", "Olympiáda", "Středoškoláci"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
    status: "past" as const,
  ...
  {
    slug: "ai-olympiada-2026-karlovarsky",
    name: "Česká AI Olympiáda 2026 — Karlovarský kraj",
    description: "Krajské kolo SŠ pro Karlovarský kraj.",
    city: "Karlovy Vary",
    venue: "VŠFS Karlovy Vary",
    startDate: d("2026-05-25T09:00:00"),
    endDate: d("2026-05-25T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/karlovarsky",
    topics: ["AI", "Olympiáda", "Středoškoláci"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
  ...
  {
    slug: "ai-olympiada-2026-liberecky",
    name: "Česká AI Olympiáda 2026 — Liberecký kraj",
    description: "Krajské kolo SŠ pro Liberecký kraj.",
    city: "Liberec",
    venue: "LipoInk",
    startDate: d("2026-05-28T09:00:00"),
    endDate: d("2026-05-28T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/liberecky",
    topics: ["AI", "Olympiáda", "Středoškoláci"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
  ...
  {
    slug: "ai-olympiada-2026-moravskoslezsky",
    name: "Česká AI Olympiáda 2026 — Moravskoslezský kraj (EDU Box Cup)",
    description:
      "Krajské kolo SŠ pro Moravskoslezský kraj — EDU Box Cup AI Olympiad.",
    city: "Ostrava",
    venue: "Tietoevry, Organica Ostrava",
    startDate: d("2026-06-01T09:00:00"),
    endDate: d("2026-06-01T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/moravskoslezky",
    topics: ["AI", "Olympiáda", "Středoškoláci", "EDU Box Cup"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
    status: "upcoming" as const,
  ...
  {
    slug: "ai-olympiada-2026-zlinsky",
    name: "Česká AI Olympiáda 2026 — Zlínský kraj",
    description: "Krajské kolo SŠ pro Zlínský kraj.",
    city: "Zlín",
    venue: "TIC Zlín",
    startDate: d("2026-06-03T09:00:00"),
    endDate: d("2026-06-03T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/zlinsky",
    topics: ["AI", "Olympiáda", "Středoškoláci"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
  ...
  {
    slug: "ai-olympiada-2026-praha",
    name: "Česká AI Olympiáda 2026 — Praha",
    description: "Krajské kolo SŠ pro hlavní město Prahu.",
    city: "Praha",
    venue: "Smíchovská střední průmyslová škola",
    startDate: d("2026-06-09T09:00:00"),
    endDate: d("2026-06-09T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/praha",
    topics: ["AI", "Olympiáda", "Středoškoláci"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
  ...
  {
    slug: "ai-olympiada-2026-plzensky",
    name: "Česká AI Olympiáda 2026 — Plzeňský kraj",
    description: "Krajské kolo SŠ pro Plzeňský kraj.",
    city: "Plzeň",
    venue: "TechTower Plzeň",
    startDate: d("2026-06-11T09:00:00"),
    endDate: d("2026-06-11T18:00:00"),
    websiteUrl: "https://www.aiolympiada.cz/kraje/plzensky",
    topics: ["AI", "Olympiáda", "Středoškoláci"],
    organizer: "NVIAS",
    isOnline: false,
    featured: false,
